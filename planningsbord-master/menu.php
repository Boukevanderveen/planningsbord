...
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@4.3.1/dist/css/bootstrap.min.css" integrity="sha384-ggOyR0iXCbMQv3Xipma34MD+dH/1fQ784/j6cY/iJTQUOhcWr7x9JvoRxT2MZw1T" crossorigin="anonymous">
 ...
 <div id="addBoardButton" onclick=" window.open('http://localhost/planningsbord-master/createboard.php','_self', '_blank'); return false;"> <p class="makeNewBoardButtonText"> Nieuw bord </p> </div>
 <div id="invitesButton" onclick=" window.open('http://localhost/planningsbord-master/invites.php','_self', '_blank'); return false;"> <p class="makeNewBoardButtonText"> Invites </p> </div>
